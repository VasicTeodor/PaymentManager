    ...
    public class Seed
    {
        ...
        public void SeedData()
        {
            if (!_context.Clients.Any())
            {
                ...
                _context.SaveChanges();
                var cardClientSeller = new Card() { Id = Guid.NewGuid(), HolderName = "Pera Prodavac", ValidTo = DateTime.UtcNow.Date.AddYears(3), Account = sellerAccount };
                ...
                var cardClientBuyerFailure = new Card() { Id = Guid.NewGuid(), HolderName = "Pera Kupac", ValidTo = DateTime.UtcNow.Date.AddYears(3), Account = buyerFailureAccount };
                cardClientBuyerFailure.Pan = _securityService.EncryptStringAes("1111225555784698");
                cardClientBuyerFailure.SecurityCode = _securityService.EncryptStringAes("2222");
                var cardClientBuyerSuccesss = new Card() { Id = Guid.NewGuid(), HolderName = "Pera Kupac", ValidTo = DateTime.UtcNow.Date.AddYears(3), Account = buyerSuccessAccount };
                cardClientBuyerSuccesss.Pan = _securityService.EncryptStringAes("1111225555784698");
                cardClientBuyerSuccesss.SecurityCode = _securityService.EncryptStringAes("1111");
                var cardOtherClientBuyerSuccess = new Card() { Id = Guid.NewGuid(), HolderName = "Pera2 Kupac", ValidTo = DateTime.UtcNow.Date.AddYears(3), Account = otherBankSuccessAccount };
                cardOtherClientBuyerSuccess.Pan = _securityService.EncryptStringAes("1131225555784698");
                cardOtherClientBuyerSuccess.SecurityCode = _securityService.EncryptStringAes("1111");
                var cardOtherClientBuyerFailure = new Card() { Id = Guid.NewGuid(), HolderName = "Pera2 Kupac", ValidTo = DateTime.UtcNow.Date.AddYears(3), Account = otherBankFailureAccount };
